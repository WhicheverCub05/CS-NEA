...
class UI:
    ...
    def __init__(self, master):
        ...
        self.steptext1 = Label(self.setupframe, text='make sure your microphone \n is connected')
        ...
        self.logtextbox = Text(self.logframe, width=45, height=5, yscrollcommand = self.scrollbar.set)
